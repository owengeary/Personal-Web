...
export default async function BookPage({ params }: PageProps) {
    ...
    return (
        <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            ...
            {/* Overview Card */}
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden shadow-sm mb-12">
                <div className="flex flex-col md:flex-row">
                    {/* Image Section - Fixed Layout */}
                    <div className="md:w-64 bg-gray-100 dark:bg-gray-800 relative h-64 md:h-auto flex-shrink-0">
                        {meta.cover ? (
                            <Image
                                src={meta.cover}
                                alt={meta.title}
                    ...
                    <div className="p-8 flex flex-col justify-center flex-1">
                        ...
                        {meta.thoughts && (
                            <div className="mb-8 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg border-l-4 border-blue-500">
                        ...
                        {meta.link && (
                            <a
                                ...
                                className="inline-flex items-center gap-2 px-6 py-3 bg-gray-900 dark:bg-white text-white dark:text-gray-900 font-medium rounded-lg hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors w-fit"
                            >
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
                <h2 className="text-2xl font-bold border-b dark:border-gray-800 pb-4 mb-6">Review & Notes</h2>
                {content}
            </div>
        </div>
    )
